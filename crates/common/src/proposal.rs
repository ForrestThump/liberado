...
/// declare their own private copy of the same literal (`docs/future-work/archive/hygiene-audit-2026-07-05.md`),
...
pub struct Proposal {
    ...
    /// plain file that process could also read (see `docs/future-work/archive/hardening-audit-2026-07-02.md`
