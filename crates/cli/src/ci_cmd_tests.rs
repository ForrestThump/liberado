...
use super::{
    ...
    emit_crap_failure, exe_lives_in_cargo_target, extract_ci_failures, git,
    keep_worse_existing_crap_entries, porcelain_path, relativize_json_file, relativize_lcov,
