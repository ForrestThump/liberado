...
/// every pool's call site (`docs/future-work/hygiene-audit-2026-07-05.md`) — building one
...
impl Orchestrator {
    ...
    /// duplicating exactly this line rather than sharing it (`docs/future-work/hygiene-audit-2026-07-05.md`).
