...
import { LiberadoAgentClient } from "./providers/liberado-agent.js";
import { LiberadoACPAgentClient } from "./providers/liberado-acp-agent.js";
...
const PROVIDER_CLIENT_FACTORIES: Record<string, ProviderClientFactory> = {
  ...
  liberado: (logger, runtimeSettings) =>
    new LiberadoAgentClient(logger, runtimeSettings),
  "liberado-acp": (logger, runtimeSettings) =>
    new LiberadoACPAgentClient(logger, runtimeSettings),
