...
export const AGENT_PROVIDER_DEFINITIONS: AgentProviderDefinition[] = [
  ...
  },
  {
    id: "liberado",
    label: "Liberado",
    description: "Rust-native personal AI Life OS with agentic coding pack, deterministic verifiers, and capability topology",
    defaultModeId: null,
    modes: [],
  },
  {
    id: "liberado-acp",
    label: "Liberado (ACP)",
    description: "Liberado via Agent Client Protocol over stdio — lightweight bridge for remote access",
    defaultModeId: null,
    modes: [],
  },
];
