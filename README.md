...
- [Session focus plan](docs/roadmap/session-focus-plan.md) — *how* the Session model was built, slice by slice (S1–S7, store convergence, forking). History; the model itself is in [Sessions](docs/architecture/sessions.md).
