...
**Depends on**: CH3 Tier 1 (persisted marker + tail re-append), shipped 2026-07-23 — see [`../roadmap/context-compaction-plan.md`](../roadmap/context-compaction-plan.md).  
...
- Shipped design: [`../roadmap/context-compaction-plan.md`](../roadmap/context-compaction-plan.md)  
- Code: `crates/main-agent/src/compaction.rs`, `crates/main-agent/src/sessions.rs` (`maybe_compact`, `elide_before_latest_marker`)  
- Reliability doctrine: [`../architecture/failure-modes.md`](../architecture/failure-modes.md) §1–§2 (real store tests; opt-in guards are off)  
