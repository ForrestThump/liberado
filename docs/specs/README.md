...
If a spec conflicts with code or with [architecture/](../architecture/README.md), follow **code + architecture living docs**, and log the conflict in [design_questions_for_the_user.md](../design_questions_for_the_user.md).
