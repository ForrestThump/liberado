...
(`docs/roadmap/current.md`'s Phase 3, `docs/roadmap/mcp-forge-backlog.md`'s inbound-trigger entries)
...
- `docs/roadmap/current.md` — Phase 3 (cron as a bus listener, vault-decoupling behind an
