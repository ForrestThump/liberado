...
**Vocabulary**: [`agentic-loops.md`](../spec/architecture/agentic-loops.md) §Vocabulary — *turn loop*
(executor) ⊂ *goal* (run-to-terminal) ⊂ *loop* (this doc) ⊂ *meta-loop* (tuner).  
**Related**: [`session-focus-plan.md`](archive/session-focus-plan.md) ·
[`verifiers.md`](../spec/architecture/verifiers.md) · cron/`EventSource` (Decision 18/19) ·
