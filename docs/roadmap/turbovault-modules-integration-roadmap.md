...
- **None of the three blocks Liberado P1.** The daemon already perceives the vault via its own watcher
  ...
  see [`current.md`](current.md). *Don't let module polish derail the daily-driver bar.*
...
## 8. How this reshapes the Liberado roadmap (`current.md`)
...
| `current.md` item | Effect of the modules |
|---|---|
...
| **Context policy** ([`liberado-context-policy-spec.md`](../specs/liberado-context-policy-spec.md)) | Real retrieval backend via live `vector_*`. |
...
**Wired into [`current.md`](current.md)** (2026-07-19): cross-cutting TurboVault modules line +
...
1. ~~**Reprioritize `current.md`?**~~ **Done 2026-07-19** — pointer + cross-cutting + what's-next.
