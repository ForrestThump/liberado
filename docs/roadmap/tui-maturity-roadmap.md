...
**Related**: [`crates/tui/ARCHITECTURE.md`](../../crates/tui/ARCHITECTURE.md), [`crates/tui/ROADMAP.md`](../../crates/tui/ROADMAP.md) (historical), [`docs/reference/api.md`](../reference/api.md), goal sessions (`liberado-session` / `/api/goals*`), agentic mesh (`docs/architecture/agentic-loops.md`), WebUI [`crates/webui`](../../crates/webui/)
