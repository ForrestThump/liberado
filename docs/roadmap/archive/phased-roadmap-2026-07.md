...
Phases 1–4 as originally sequenced, with the completion notes written as each landed. **All four are
substantially done.** This is kept for the *reasoning* — why the sequence was chosen, what each phase
was for, and what was deliberately deferred — not as a description of current work.
