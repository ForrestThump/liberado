...
5. [Failure modes](spec/architecture/failure-modes.md) — seven recurring bug classes
...
**Last updated:** 2026-07-31 — docs reorganized per `project/` → `spec/impl/future-work/validation/project` schema.
