...
Living description of **how Liberado works today**. Historical plans belong in [roadmap/archive](../roadmap/archive/README.md).
...
**Crate-level docs:** [reference/crate-map.md](../reference/crate-map.md) and `crates/*/ARCHITECTURE.md`.

**Related:** [specs/](../specs/README.md) for decision log and detailed specs; [roadmap/current.md](../roadmap/current.md) for open work.
