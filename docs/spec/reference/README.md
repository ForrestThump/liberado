...
Machine-oriented contracts and generated inventories.
...
| [slim-build.md](slim-build.md) | Slim build profile — fenced sidecars, gated package list, full vs slim cargo invocations |
...
Architecture narrative: [../../spec/architecture/README.md](../../spec/architecture/README.md).
