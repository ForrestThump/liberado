...
| Crate | Internal deps | Description |
|---|---|---|
| [`liberado-coder-agent`](../../../crates/coder-agent/) | `liberado-coder-core`, `liberado-coder-sandbox`, `liberado-coder-tools`, `liberado-common`, `liberado-executor`, `liberado-provider`, `liberado-session` | Coding domain pack: Liberado goal-session backend over Executor + coding tools (not the session kernel) |
...
| [`liberado-coder-runner`](../../../crates/coder-runner/) | `liberado-coder-agent`, `liberado-coder-core`, `liberado-coder-tools`, `liberado-common`, `liberado-config-loader`, `liberado-provider`, `liberado-provider-openai-compat` | Process boundary for the coding pack: the liberado-coder-run subprocess bridge nested consumers (PR factory) drive over JSON. |
| [`liberado-coder-sandbox`](../../../crates/coder-sandbox/) | `liberado-coder-core`, `liberado-common` | Workspace and command sandbox abstractions for Liberado's Rust-native coder |
| [`liberado-coder-tools`](../../../crates/coder-tools/) | `liberado-coder-core`, `liberado-coder-sandbox`, `liberado-common`, `liberado-executor`, `liberado-provider` | Executor ToolRuntime implementation for Liberado's Rust-native coder |
...
| Crate | Internal deps | Description |
|---|---|---|
| [`liberado-tui`](../../../crates/tui/) | `chat-client-contract`, `liberado-commands`, `liberado-markdown`, `liberado-theme` | ratatui TUI client for Liberado — chat pane, status line, reactions feed; drives the shared HTTP/SSE API (docs/reference/api.md) |
...
| Crate | Internal deps | Description |
|---|---|---|
| [`liberado-acp-bridge`](../../../crates/acp-bridge/) | `chat-client-contract`, `liberado-bootstrap`, `liberado-coder-agent`, `liberado-coder-core`, `liberado-coder-sandbox`, `liberado-coder-tools`, `liberado-common`, `liberado-config`, `liberado-executor`, `liberado-main-agent`, `liberado-provider`, `liberado-provider-openai-compat`, `liberado-session` | ACP (Agent Client Protocol) bridge over stdio for Paseo integration. |
| [`liberado-bootstrap`](../../../crates/bootstrap/) | `liberado-coder-agent`, `liberado-coder-core`, `liberado-common`, `liberado-config`, `liberado-cron`, `liberado-daemon`, `liberado-dispatch-pack`, `liberado-dispatcher`, `liberado-executor`, `liberado-mcp`, `liberado-notify`, `liberado-orchestrator`, `liberado-provider`, `liberado-provider-openai-compat` | Composition helpers that build Liberado's provider/dispatcher/orchestrator from the process environment — the shared daemon-assembly logic for every binary, so the env wiring lives in one place. |
| [`liberado-cli`](../../../crates/cli/) | `chat-client-contract`, `liberado-coder-core`, `liberado-common`, `liberado-config`, `liberado-config-loader`, `liberado-harness-eval`, `liberado-ops`, `liberado-server` | the `liberado` binary: a client + launcher — `serve` runs the daemon/API, `chat` is a streaming client |
| [`liberado-daemon`](../../../crates/daemon/) | `liberado-common`, `liberado-config`, `liberado-dispatcher`, `liberado-notify`, `liberado-orchestrator`, `liberado-provider`, `liberado-session`, `liberado-vault` | The Liberado daemon (Decision 2, daemon-first): the long-running core that watches the vault, attributes changes (loop-breaking), and emits reactable events. v1 vertical slice. |
| [`liberado-server`](../../../crates/server/) | `chat-client-contract`, `liberado-bootstrap`, `liberado-chat-search`, `liberado-coder-agent`, `liberado-coder-core`, `liberado-commands`, `liberado-common`, `liberado-config`, `liberado-conversation-store`, `liberado-cost`, `liberado-daemon`, `liberado-dispatcher`, `liberado-executor`, `liberado-main-agent`, `liberado-mcp`, `liberado-memory-store`, `liberado-messaging`, `liberado-notify`, `liberado-provider`, `liberado-session`, `liberado-session-store`, `liberado-telegram-approvals`, `liberado-vault` | The Liberado daemon's API server (library): the watch loop + chat + HTTP/SSE API. Runnable via `liberado serve`. |
...
| Crate | Internal deps | Description |
|---|---|---|
| [`liberado-conformance`](../../../crates/conformance/) | `chat-client-contract`, `liberado-common` | Tier 3 live conformance runner: exercises each execution path against a deployed daemon over HTTP, asserts ground-truth outcomes, writes vault reports. Hand-run on the box for v1. |
...
| [`liberado-ops`](../../../crates/ops/) | `liberado-common`, `liberado-config`, `liberado-config-loader`, `liberado-cost` | Cross-platform operator workflows for Liberado: deployment, development processes, and external surface installation |
