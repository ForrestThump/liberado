...
slots in as an MCP (see the [roadmap](../../roadmap.md)). It is homelab-PR-shaped today and still
...
[`docs/ideas/vs-hermes.md`](../../future-work/ideas/vs-hermes.md) for the detailed Hermes gap analysis.*
